    ...
    ImagePicker.openPicker({
      ...
      .then(image => {
        if (image?.size > 1050000) {
          closeBottomSheet?.();
          showErrorModal("L'image ne doit pas dépasser 1 Mo");
          return;
        }
        onChange?.(image);
        closeBottomSheet?.();
      ...
      .catch(error => {
        ...
        showErrorModal("Échec de la sélection de l'image. Veuillez réessayer.");
      });
  };
        ...
        <Modal
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              ...
              <Button title="Fermer" onPress={closeErrorModal} />
            </View>
          </View>
        </Modal>
        {profileDetails ? (
        ...
        <BottomSheetView style={styles.bottomSheetContentContainer}>
          ...
          <View style={styles.contentConatiner}>
            <Pressable style={styles.iconContainer} onPress={HandlePicture}>
              ...
              />
              <CustomText
                text="Prendre une photo maintenant"
            ...
            <Pressable style={styles.iconContainer} onPress={HandleGalary}>
              ...
              />
              <CustomText
                text="Sélectionner depuis la galerie du téléphone"
                textStyle={styles.bottomSheetContentDescription}
              />
            </Pressable>
          </View>
